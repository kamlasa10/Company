...
window.addEventListener('DOMContentLoaded', function () {
  var slider = new _modules_slider_mainSlider__WEBPACK_IMPORTED_MODULE_1__["default"]({
    container: '.page',
    btns: '.next'
  });
  slider.render();
  var moduleSlider = new _modules_slider_mainSlider__WEBPACK_IMPORTED_MODULE_1__["default"]({
    container: '.moduleapp',
    btns: '.next'
  }, '.nextmodule', '.prevmodule');
  moduleSlider.render();
  new _modules_accordion__WEBPACK_IMPORTED_MODULE_5__["default"]('.module__info-show .plus').init();
  new _modules_download__WEBPACK_IMPORTED_MODULE_6__["default"]('.download .download__text').init();
  var playVideo = new _modules_playVideo__WEBPACK_IMPORTED_MODULE_0__["default"]('.play', '.overlay');
  playVideo.init();
  new _modules_playVideo__WEBPACK_IMPORTED_MODULE_0__["default"]('.module__video-item .play', '.overlay').init();
  var slideMini = new _modules_slider_slider_mini__WEBPACK_IMPORTED_MODULE_2__["default"]({
  ...
  slideMini.init();
  var slideMiniModules = new _modules_slider_slider_mini__WEBPACK_IMPORTED_MODULE_2__["default"]({
  ...
  var slideMiniFeed = new _modules_slider_slider_mini__WEBPACK_IMPORTED_MODULE_2__["default"]({
    ...
    value: function bindTrigger() {
      this.triggers.forEach(function (item) {
        item.addEventListener('click', function () {
          var msg = item.parentElement.nextElementSibling;
...
/*#__PURE__*/
function () {
  function Difference(officeOld, officeNew, items) {
  ...
  _createClass(Difference, [{
    ...
    key: "showItems",
    value: function showItems(trigger, items, idx) {
      try {
...
function () {
  ...
  _createClass(Download, [{
    key: "createBtn",
    value: function createBtn(file, item) {
...
function () {
  ...
  _createClass(Forms, [{
    ...
    key: "serviceData",
    value: function serviceData(url, data) {
      return regeneratorRuntime.async(function serviceData$(_context) {
        while (1) {
    ...
    value: function init() {
      ...
      this.forms.forEach(function (item) {
        item.addEventListener('submit', function (e) {
          ...
          statusMessage.textContent = _this.statusMessage.loading;
          statusMessage.style.cssText = "\n          margin-top: 20px;\n          color: grey;\n          font-size: 18px;\n        ";
          item.appendChild(statusMessage);
          var formData = new FormData(item);

          _this.serviceData(_this.path, formData).then(function (res) {
            statusMessage.textContent = _this.statusMessage.success;
          }).catch(function (e) {
            statusMessage.textContent = _this.statusMessage.failure;
          }).finally(function () {
            item.reset();
            setTimeout(function () {
...
/*#__PURE__*/
function () {
  function PlayVideo(trigger, overlay) {
  ...
  _createClass(PlayVideo, [{
        ...
        item.addEventListener('click', function (e) {
          ...
          if (!item.getAttribute('data-disabled') || item.getAttribute('data-disabled') !== 'true') {
            ...
            if (document.querySelector('iframe#frame')) {
              ...
              _this.createVideoPlayer(_this.path);
            }
          }
        });
      });
    ...
    value: function onPlayerStateChange(state) {
      if (state.data === 0) {
        ...
        var play = this.active.querySelector('svg').cloneNode(true);
...
function (_Slider) {
  ...
  function MainSlider(container, next, prev) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(MainSlider).call(this, container));
    _this.next = document.querySelectorAll(next);
    _this.prev = document.querySelectorAll(prev);
    return _this;
  }
      ...
      if (this.container) {
        ...
        try {
          ...
          if (this.slideIndex === 3) {
            setTimeout(function () {
              _this2.hanson.style.display = 'block';
    ...
    value: function bindTriggers() {
      ...
      if (this.container) {
        ...
        this.btns.forEach(function (item) {
          ...
          item.parentElement.previousElementSibling.addEventListener('click', function (e) {
            e.preventDefault();
            _this3.slideIndex = 1;
...
function (_Slider) {
  ...
  function SliderMini(container, prev, next, active, animated, autoPlay) {
    _classCallCheck(this, SliderMini);

    return _possibleConstructorReturn(this, _getPrototypeOf(SliderMini).call(this, container, prev, next, active, animated, autoPlay));
  }
    ...
    value: function bindTrigger() {
      ...
      try {
        this.next.addEventListener('click', function () {
          if (_this2.slides[1].nodeName === 'BUTTON' && _this2.slides[2].nodeName === 'BUTTON') {
...
var Slider = function Slider() {
  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      ...
      animated = _ref$animated === void 0 ? null : _ref$animated,
